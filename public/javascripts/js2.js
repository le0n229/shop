// корзина
const basket = [];// массив для хранения объектов в корзине
const cartProducts = document.getElementById('cartProducts');// блок для вставки продуктов в корзине
const addProductButton = document.getElementsByClassName('cartlink');// кнопка добавления продуктов в корзину
