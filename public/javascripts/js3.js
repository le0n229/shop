...
const productCatalog = document.getElementById('product');
const product = [{
...
for (let i = 0; i < product.length; i++) {
  const productCatalogItem = document.createElement('div');
...
const $img = document.getElementsByClassName('f1');// картинки на которые вешаем обработкик для вызова модального окна
